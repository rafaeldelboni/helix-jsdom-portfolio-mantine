...
var i_33746 = (0);
while(true){
if((i_33746 < arr.length)){
(arr[i_33746] = null);

var G__33747 = (i_33746 + (1));
i_33746 = G__33747;
continue;
} else {
}
...
var i_33760 = (self__.level + (1));
while(true){
if((i_33760 <= (new_level + (1)))){
(update[i_33760] = self__.header);

var G__33761 = (i_33760 + (1));
i_33760 = G__33761;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33762 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33762[i]));
} else {
x__$2.forward.push((((i < links_33762.length))?(links_33762[i]):null));
}

if((i < links_33762.length)){
(links_33762[i] = x__$2);
} else {
links_33762.push(x__$2);
}
...
var i_33767 = (0);
while(true){
if((i_33767 <= self__.level)){
var links_33768 = (update[i_33767]).forward;
if((x__$1 === (((i_33767 < links_33768.length))?(links_33768[i_33767]):null))){
(links_33768[i_33767] = (x__$1.forward[i_33767]));

var G__33769 = (i_33767 + (1));
i_33767 = G__33769;
continue;
} else {
var G__33770 = (i_33767 + (1));
i_33767 = G__33770;
continue;
}
} else {
...
var G__33775 = nx;
var G__33776 = (level__$1 - (1));
x = G__33775;
level__$1 = G__33776;
continue;
} else {
var G__33777 = x;
var G__33778 = (level__$1 - (1));
x = G__33777;
level__$1 = G__33778;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33781 = nx;
var G__33782 = (level__$1 - (1));
x = G__33781;
level__$1 = G__33782;
continue;
} else {
var G__33783 = x;
var G__33784 = (level__$1 - (1));
x = G__33783;
level__$1 = G__33784;
continue;
}
