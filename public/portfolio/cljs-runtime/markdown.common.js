...
var len__5769__auto___42520 = arguments.length;
var i__5770__auto___42521 = (0);
while(true){
if((i__5770__auto___42521 < len__5769__auto___42520)){
args__5775__auto__.push((arguments[i__5770__auto___42521]));

var G__42522 = (i__5770__auto___42521 + (1));
i__5770__auto___42521 = G__42522;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq42485){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42485));
}));
...
var G__42523 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5802__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__42488_SHARP_,p1__42488_SHARP_);
});})(text,state,matches,temp__5802__auto__))
);
});})(text,state,matches,temp__5802__auto__))
,text,matches);
var G__42524 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5802__auto__){
return (function (p1__42489_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__42489_SHARP_,matches);
});})(text,state,matches,temp__5802__auto__))
);
text = G__42523;
state = G__42524;
...
var vec__42504 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__42507 = (function (){var G__42510 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__42511 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__42510,G__42511) : transformer.call(null,G__42510,G__42511));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42507,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42507,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42504,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42504,(1),null);
var G__42527 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__42528 = cljs.core.PersistentVector.EMPTY;
var G__42529 = cljs.core.rest(tokens);
var G__42530 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__42527;
buf = G__42528;
tokens = G__42529;
cur_state = G__42530;
...
var G__42531 = out;
var G__42532 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__42533 = cljs.core.rest(tokens);
var G__42534 = cur_state;
out = G__42531;
buf = G__42532;
tokens = G__42533;
cur_state = G__42534;
...
var G__42535 = out;
var G__42536 = buf;
var G__42537 = cljs.core.rest(tokens);
var G__42538 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__42535;
buf = G__42536;
tokens = G__42537;
cur_state = G__42538;
...
var G__42539 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__42540 = buf;
var G__42541 = cljs.core.rest(tokens);
var G__42542 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__42539;
buf = G__42540;
tokens = G__42541;
cur_state = G__42542;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__42518_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__42518_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__42519_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__42519_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__42519_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
