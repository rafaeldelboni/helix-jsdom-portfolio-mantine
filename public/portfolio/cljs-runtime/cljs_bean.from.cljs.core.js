...
var G__31816 = cljs.core.next(xs);
var G__31817 = cljs.core.next(ys);
xs = G__31816;
ys = G__31817;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__31697 = val;
var G__31698 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31697,G__31698) : f.call(null,G__31697,G__31698));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__31703 = val__$1;
var G__31704 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31703,G__31704) : f.call(null,G__31703,G__31704));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__31709 = val__$1;
var G__31710 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31709,G__31710) : f.call(null,G__31709,G__31710));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__31834 = cljs.core.next(es);
var G__31835 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__31834;
tcoll__$1 = G__31835;
continue;
} else {
...
var G__31846 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__31847 = cljs.core.next(es);
ret = G__31846;
es = G__31847;
continue;
} else {
