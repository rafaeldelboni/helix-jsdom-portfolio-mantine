...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43623 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43623(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43624 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43624(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43625 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43625(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43626 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43626(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43627 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43627(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43628 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43628(reader);
}
});
...
var G__43643 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43644 = s.append(c);
c = G__43643;
s = G__43644;
continue;
}
