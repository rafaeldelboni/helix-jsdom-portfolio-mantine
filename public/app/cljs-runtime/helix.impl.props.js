...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__31389_SHARP_,p2__31388_SHARP_){
return p2__31388_SHARP_.toUpperCase();
}));
...
var G__31392 = o;
helix.impl.props.goog$module$goog$object.set(G__31392,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__31419 = cljs.core.rest(m);
var G__31420 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31403_SHARP_){
if(cljs.core.map_QMARK_(p1__31403_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__31403_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__31424 = cljs.core.rest(m);
var G__31425 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__31432 = cljs.core.rest(m);
var G__31433 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
