...
var G__30961 = cljs.core.next(xs);
var G__30962 = cljs.core.next(ys);
xs = G__30961;
ys = G__30962;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__30919 = val;
var G__30920 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30919,G__30920) : f.call(null,G__30919,G__30920));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__30922 = val__$1;
var G__30923 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30922,G__30923) : f.call(null,G__30922,G__30923));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__30925 = val__$1;
var G__30926 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30925,G__30926) : f.call(null,G__30925,G__30926));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__31001 = cljs.core.next(es);
var G__31002 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__31001;
tcoll__$1 = G__31002;
continue;
} else {
...
var G__31004 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__31005 = cljs.core.next(es);
ret = G__31004;
es = G__31005;
continue;
} else {
