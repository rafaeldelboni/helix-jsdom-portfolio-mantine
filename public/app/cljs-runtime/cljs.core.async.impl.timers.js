...
var i_35716 = (0);
while(true){
if((i_35716 < arr.length)){
(arr[i_35716] = null);

var G__35717 = (i_35716 + (1));
i_35716 = G__35717;
continue;
} else {
}
...
var i_35730 = (self__.level + (1));
while(true){
if((i_35730 <= (new_level + (1)))){
(update[i_35730] = self__.header);

var G__35731 = (i_35730 + (1));
i_35730 = G__35731;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_35732 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_35732[i]));
} else {
x__$2.forward.push((((i < links_35732.length))?(links_35732[i]):null));
}

if((i < links_35732.length)){
(links_35732[i] = x__$2);
} else {
links_35732.push(x__$2);
}
...
var i_35740 = (0);
while(true){
if((i_35740 <= self__.level)){
var links_35741 = (update[i_35740]).forward;
if((x__$1 === (((i_35740 < links_35741.length))?(links_35741[i_35740]):null))){
(links_35741[i_35740] = (x__$1.forward[i_35740]));

var G__35742 = (i_35740 + (1));
i_35740 = G__35742;
continue;
} else {
var G__35743 = (i_35740 + (1));
i_35740 = G__35743;
continue;
}
} else {
...
var G__35750 = nx;
var G__35751 = (level__$1 - (1));
x = G__35750;
level__$1 = G__35751;
continue;
} else {
var G__35752 = x;
var G__35753 = (level__$1 - (1));
x = G__35752;
level__$1 = G__35753;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__35755 = nx;
var G__35756 = (level__$1 - (1));
x = G__35755;
level__$1 = G__35756;
continue;
} else {
var G__35757 = x;
var G__35758 = (level__$1 - (1));
x = G__35757;
level__$1 = G__35758;
continue;
}
